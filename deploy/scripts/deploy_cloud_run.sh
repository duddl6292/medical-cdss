...
gcloud run jobs deploy "${BACKEND_SERVICE}-migrate" \
  ...
  --set-env-vars "DJANGO_DEBUG=false,DB_NAME=${DB_NAME},DB_USER=${DB_MIGRATOR_USER},DB_HOST=/cloudsql/${CLOUD_SQL_CONNECTION},DB_PORT=5432,DB_CONN_MAX_AGE=0" \
